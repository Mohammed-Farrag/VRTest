...
export class SimilarProducts extends Component {
    state = {
        products: [
            {
                thumbnail: 'staticImages/similar.png',
                ...
                discount: 50,
                trademark: 'staticImages/adidas.png',
                rating: 4.6,
      ...
      >
        ...
        <div className="flex mt-3 flex-col sm:flex-row gap-4">
            {this.state.products.map((prod, index) => (
                <div className="px-1  flex flex-col gap-1 shadow-sm  sm:px-0 shadow-slate-400"  key={index}>
                    ...
                    <div className="flex justify-between items-center"> 
                        ...
                        <img className='w-14' src={prod.trademark} alt="" />
                    </div>
                    <div className="">
